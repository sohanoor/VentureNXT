...
public class LoginActivity extends AppCompatActivity {
    ...
    public boolean userLogIn(final String email, final String password) {
        String url = api.USER_LOG_IN_API;
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            boolean userTry = userLogIn(email, password);
            if (userTry) {
                Toast.makeText(getApplicationContext(), "Log In Complete", Toast.LENGTH_SHORT).show();
                Intent dashboardIntent = (Intent) new Intent(LoginActivity.this, DashboardActivity.class);
                dashboardIntent.putExtra("Authorization", Authorization);
